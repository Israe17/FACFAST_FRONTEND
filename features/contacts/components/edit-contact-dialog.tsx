  ...
  useEffect(() => {
    if (contactQuery.data) {
      form.reset({
        ...
        canton_id: contactQuery.data.canton_id ?? null,
        code: contactQuery.data.code ?? "",
        commercial_name: contactQuery.data.commercial_name ?? "",
        country_id: contactQuery.data.country_id ?? null,
        delivery_latitude: contactQuery.data.delivery_latitude ?? null,
        delivery_longitude: contactQuery.data.delivery_longitude ?? null,
        district: contactQuery.data.district ?? "",
        district_id: contactQuery.data.district_id ?? null,
        ...
        province_id: contactQuery.data.province_id ?? null,
