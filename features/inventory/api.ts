...
function buildProductPayload(
  ...
  return compactRecord({
    ...
    cabys_code: payload.cabys_code?.trim() || undefined,
    cabys_descripcion: payload.cabys_descripcion?.trim() || undefined,
    cabys_impuesto: payload.cabys_impuesto,
...
export async function listDispatchOrdersCursor(
  params: CursorQueryParams,
  filters: DispatchOrdersListFilters = {},
) {
  const queryParams = compactRecord({
    ...params,
