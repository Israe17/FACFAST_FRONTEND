...
const esTranslations = {
  ...
  "branches.create_title": "Crear sucursal",
  "branches.create_description": "Registra una nueva sucursal.",
  "branches.edit_title": "Editar sucursal",
  "branches.edit_description": "Actualiza la información de la sucursal.",
  "branches.create_terminal_title": "Crear terminal",
  ...
  "date_range.placeholder": "Cualquier fecha",
  "date_range.preset_today": "Hoy",
  "date_range.preset_this_week": "Esta semana",
  ...
  "common.save_success": "Guardado exitosamente.",
  ...
  "contacts.hacienda.lookup_button": "Consultar Hacienda",
  "contacts.hacienda.lookup_error": "No fue posible consultar a Hacienda.",
  "contacts.hacienda.lookup_success": "Datos del contribuyente cargados desde Hacienda.",
  "contacts.hacienda.not_found": "No se encontro el contribuyente en Hacienda.",
  "contacts.hacienda.select_activity": "Selecciona una actividad economica",
  "contacts.hacienda.select_activity_description":
    "El contribuyente tiene varias actividades registradas. Selecciona la que aplica.",
  "contacts.hacienda.verify_button": "Verificar",
  "contacts.hacienda.verify_error": "No fue posible verificar el documento de exoneracion.",
  "contacts.hacienda.verify_success": "Datos de exoneracion cargados desde Hacienda.",
  "contacts.hacienda.verifying": "Verificando...",
  ...
  "contacts.form.district_placeholder": "Ej: Carmen",
  "contacts.form.document_number": "Número de documento",
  "contacts.form.economic_activity_code": "Código de actividad economica",
  "contacts.form.economic_activity_code_placeholder": "Se completa al consultar Hacienda",
  "contacts.form.email": "Correo electrónico",
  "contacts.form.email_placeholder": "correo@empresa.com",
  "contacts.form.exoneration_description": "Campos opcionales para condiciones tributarias especiales.",
  "contacts.form.exoneration_document_placeholder": "Ej: AL-00460853-20",
  "contacts.form.exoneration_institution_placeholder": "Se completa al verificar",
  "contacts.form.exoneration_percentage": "Porcentaje de exoneración",
  "contacts.form.exoneration_percentage_placeholder": "Ej: 13",
  "contacts.form.exoneration_title": "Exoneración",
  "contacts.form.exoneration_type": "Tipo de exoneración",
  "contacts.form.exoneration_type_placeholder": "Se completa al verificar",
  ...
  "contacts.form.identification_number_placeholder": "Ej: 3101025306",
  ...
  "contacts.form.phone_placeholder": "8888-8888",
  "contacts.form.province": "Provincia",
  "contacts.form.province_placeholder": "Ej: San José",
  ...
  "contacts.form.tax_condition_placeholder": "Se completa al consultar Hacienda",
  ...
  "inventory.common.number": "Número",
  ...
  "inventory.cabys.no_results": "Sin resultados en el catálogo CABYS",
  "inventory.cabys.search_placeholder": "Buscar bien o servicio en CABYS...",
  "inventory.cabys.tax_rate": "IVA",
  ...
  "inventory.dispatch.change_stop_status": "Cambiar estado",
  ...
  "roles.create_title": "Crear rol",
  "roles.create_description": "Crea un nuevo rol para administración RBAC.",
  "roles.edit_title": "Editar rol",
  "roles.edit_description": "Actualiza los detalles de este rol.",
  "roles.page_title": "Roles",
  "roles.page_description": "Gestiona roles, edita metadatos y asigna conjuntos de permisos para RBAC.",
  "roles.page_eyebrow": "Administración",
  "roles.page_access_denied": "No tienes permiso para ver los roles.",
  "roles.create_button": "Crear rol",
  "roles.loading": "Cargando roles.",
  "roles.load_error_fallback": "No fue posible cargar los roles.",
  "roles.empty_title": "No se encontraron roles",
  "roles.empty_description": "Crea el primer rol para estructurar el RBAC.",
  "roles.source_badge": "Fuente de roles: /api/roles",
  "roles.permissions_catalog_badge": "Catálogo de permisos: {count}",
  "roles.permissions_catalog_loading": "cargando",
  "roles.table.header_role": "Rol",
  "roles.table.header_role_key": "Clave de rol",
  "roles.table.header_permissions": "Permisos",
  "roles.table.system_badge": "Sistema",
  "roles.table.code_prefix": "Código: {code}",
  "roles.table.key_prefix": "Clave: {key}",
  "roles.table.no_permissions": "Sin permisos",
  "roles.table.empty": "No se encontraron roles.",
  "roles.actions.edit": "Editar rol",
  "roles.actions.assign_permissions": "Asignar permisos",
  "roles.actions.delete": "Eliminar rol",
  "roles.delete_title": "Eliminar rol",
  "roles.delete_description": "Esto eliminará el rol {name}.",
  "roles.delete_confirm": "Eliminar rol",
  "roles.form.name_label": "Nombre",
  "roles.form.name_placeholder": "Ej. Encargado",
  "roles.form.role_key_label": "Clave del rol",
  "roles.form.role_key_placeholder": "ej. encargado",
  ...
  "users.create_description": "Crea un nuevo usuario.",
  "users.edit_title": "Editar usuario",
  "users.edit_description": "Actualiza la información del usuario.",
  "users.loading_details": "Cargando detalles del usuario.",
  "users.change_password_title": "Cambiar contraseña",
  "users.change_password_description": "Establece una nueva contraseña para este usuario.",
  ...
  "users.change_status_title": "Cambiar estado del usuario",
  "users.change_status_description": "Usa estados de ciclo de vida para administración no destructiva.",
  "users.status_label": "Estado",
  "users.status_placeholder": "Selecciona un estado",
  "users.allow_login": "Permitir login",
  "users.allow_login_description": "Controla si el usuario puede autenticarse.",
  "users.save_status": "Guardar estado",
  "users.status_active_description": "El usuario puede operar normalmente.",
  "users.status_inactive_description": "El usuario permanece registrado pero no debe operar.",
  "users.status_suspended_description": "Acceso temporalmente suspendido.",
  "users.status_deleted_description": "Estado de eliminación lógica.",
  "users.assign_roles_title": "Asignar roles",
  "users.assign_roles_description": "Actualiza los roles asignados a {name}.",
  "users.save_roles": "Guardar roles",
  "users.loading_roles": "Cargando roles disponibles.",
  "users.load_roles_error": "No se pudieron cargar los roles.",
  "users.no_roles_title": "Sin roles disponibles",
  "users.no_roles_description": "No hay roles para asignar todavía.",
  "users.role_code": "Código: {code}",
  "users.role_key": "Clave: {key}",
  "users.assign_branches_title": "Asignar sucursales",
  "users.assign_branches_description": "Actualiza el acceso de {name} a las sucursales.",
  "users.active_branch_badge": "Sucursal activa: {branch}",
  "users.allowed_branches_badge": "Sucursales permitidas: {count}",
  "users.loading_branches": "Cargando sucursales.",
  "users.load_branches_error": "No se pudieron cargar las sucursales.",
  "users.no_branches_title": "Sin sucursales disponibles",
  "users.no_branches_description": "No se encontraron sucursales.",
  "users.save_branches": "Guardar sucursales",
  "users.effective_permissions_title": "Permisos efectivos",
  "users.effective_permissions_description": "Permisos resueltos actualmente para {name}.",
  "users.loading_permissions": "Cargando permisos efectivos.",
  "users.load_permissions_error": "No se pudieron cargar los permisos efectivos.",
  "users.no_permissions_title": "Sin permisos",
  "users.no_permissions_description": "Este usuario no tiene permisos efectivos.",
  ...
  "inventory.dispatch.search_sale_orders_placeholder": "Buscar por código o cliente…",
  "inventory.dispatch.delivery_sequence": "Secuencia de entrega",
  ...
  "auth.login_error_fallback": "No fue posible iniciar sesión.",
  "auth.superadmin_hint": "El onboarding de nuevas empresas ahora vive dentro del panel de plataforma para usuarios con acceso super admin.",
  "branches.form.map_location": "Ubicación en mapa",
  "branches.switcher.business_level_context": "Contexto activo: nivel empresa",
  "branches.switcher.fixed_branch": "Sucursal fija: {label}",
  "branches.switcher.no_branches": "Sin sucursales",
  "branches.switcher.select_branch": "Selecciona sucursal",
  "contacts.form.map_location": "Ubicación en mapa",
  "sales.form.seller_route_requires_delivery": "Ruta de vendedor requiere entrega a domicilio.",
  "sales.form.select_branch": "Selecciona una sucursal",
  "sales.form.select_customer": "Selecciona un cliente",
  "sales.form.no_seller_assigned": "Sin vendedor asignado",
  "sales.form.no_seller": "Sin vendedor",
  "sales.form.no_warehouse_assigned": "Sin bodega asignada",
  "sales.form.no_warehouse": "Sin bodega",
  "sales.form.no_zone_assigned": "Sin zona asignada",
  "sales.form.no_zone": "Sin zona",
  "sales.form.select_product": "Selecciona producto",
  "sales.form.stock_label": "({count} disp.)",
  "sales.charge_type_shipping": "Envío",
  "sales.charge_type_installation": "Instalación",
  "sales.charge_type_express": "Express",
  "common.access_denied_title": "Acceso denegado",
  "common.none": "Ninguno",
  "common.active_status": "ACTIVO",
  "common.inactive_status": "INACTIVO",
  ...
  "common.delete_permanently": "Eliminar permanentemente",
  "common.administration": "Administración",
  "users.page_eyebrow": "Administración",
  "users.page_title": "Usuarios",
  "users.page_description": "Gestiona usuarios, estados, contraseñas, roles, sucursales y permisos efectivos.",
  "users.page_access_denied": "No tienes permiso para ver usuarios.",
  "users.loading_users": "Cargando usuarios.",
  "users.create_button": "Crear usuario",
  "users.empty_title": "Sin usuarios",
  "users.empty_description": "Crea el primer registro de usuario para este negocio.",
  "users.active_branch_context": "Sucursal activa: {value}",
  "users.table.header_user": "Usuario",
  "users.table.header_status": "Estado",
  "users.table.header_roles": "Roles",
  "users.table.header_branches": "Sucursales",
  "users.table.header_max_discount": "Descuento máx.",
  "users.table.header_updated": "Actualizado",
  "users.table.header_actions": "Acciones",
  "users.table.no_roles": "Sin roles",
  "users.table.branches_assigned": "{count} asignada(s)",
  "users.table.empty": "No se encontraron usuarios.",
  "users.actions.menu_label": "Acciones",
  "users.actions.edit": "Editar usuario",
  "users.actions.change_status": "Cambiar estado",
  "users.actions.change_password": "Cambiar contraseña",
  "users.actions.assign_roles": "Asignar roles",
  "users.actions.assign_branches": "Asignar sucursales",
  ...
  "users.delete_dialog_description": "Esto elimina permanentemente a {name}. Usa cambios de estado para administración regular y reserva la eliminación para limpieza de usuarios sin historial operativo.",
  "users.kpi.total_title": "Usuarios",
  "users.kpi.active_hint": "{count} activos",
  "users.kpi.branches_title": "Sucursales",
  "users.kpi.filtered_title": "En vista",
  "users.search_placeholder": "Buscar por nombre, correo o código…",
  "users.branch_filter.placeholder": "Filtrar por sucursal",
  "users.branch_filter.all": "Todas las sucursales",
  "users.branch_filter.none": "Sin sucursal asignada",
  "users.filter_results": "{count} de {total} usuarios",
  "users.filter_empty_title": "Sin coincidencias",
  "users.filter_empty_description": "Ajusta la búsqueda o el filtro de sucursal para ver usuarios.",
  "users.select_user_title": "Selecciona un usuario",
  "users.select_user_description": "Elige un usuario de la lista para ver su detalle, roles, sucursales y permisos.",
  "users.detail.platform_admin_badge": "Platform admin",
  "users.detail.roles_count": "{count} rol(es)",
  "users.detail.branches_count": "{count} sucursal(es)",
  "users.detail.last_login": "Último acceso: {value}",
  "users.detail.tabs.roles": "Roles ({count})",
  "users.detail.tabs.branches": "Sucursales ({count})",
  "users.detail.tabs.permissions": "Permisos efectivos",
  "users.detail.tabs.activity": "Movimientos",
  "users.detail.roles_empty_title": "Sin roles asignados",
  "users.detail.roles_empty_description": "Este usuario no tiene roles asignados todavía.",
  "users.detail.roles_empty_guidance": "{name} no tiene roles. Sin un rol no podrá iniciar sesión con permisos ni operar en el sistema. Asigna al menos un rol para que tenga permisos efectivos.",
  "users.detail.branches_empty_title": "Sin sucursales asignadas",
  "users.detail.branches_empty_description": "Este usuario aún no tiene acceso a ninguna sucursal.",
  "users.detail.branches_empty_guidance": "{name} no tiene sucursales asignadas. Sin acceso a una sucursal no podrá operar (vender, despachar ni mover inventario). Asigna al menos una sucursal donde pueda trabajar.",
  "users.detail.branches_empty_privileged": "{name} es propietario o platform admin y opera a nivel empresa, por lo que no requiere asignación explícita de sucursales.",
  "users.detail.permissions_no_roles_title": "Sin permisos efectivos",
  "users.detail.permissions_no_roles_description": "{name} no tiene permisos porque no tiene roles asignados. Los permisos efectivos provienen de los roles. Asigna al menos un rol para que aparezcan permisos aquí.",
  "users.detail.permissions_empty_with_roles_title": "Roles sin permisos",
  "users.detail.permissions_empty_with_roles_description": "{name} tiene roles asignados pero ninguno otorga permisos. Edita los roles desde la sección Roles para configurar sus permisos.",
  "users.detail.permissions_group_count": "{count} permisos",
  "users.detail.permissions_empty_privileged_title": "Acceso total implícito",
  "users.detail.permissions_empty_privileged_description": "{name} es propietario o platform admin, por lo que tiene acceso completo independientemente de los permisos efectivos calculados.",
  "users.detail.roles_platform_admin_title": "Roles no aplicables",
  "users.detail.roles_platform_admin_description": "{name} es platform admin: no se le asignan roles porque tiene acceso total implícito a todas las operaciones del sistema.",
  "users.detail.branches_platform_admin_title": "Sucursales no aplicables",
  "users.detail.branches_platform_admin_description": "{name} es platform admin y opera a nivel plataforma, por lo que no requiere asignación de sucursales: puede actuar sobre cualquiera.",
  "users.detail.status_warning_title": "Usuario en estado: {status}",
  "users.detail.status_warning_description": "Mientras el usuario no esté activo, no podrá iniciar sesión ni operar. Cambia el estado a Activo si quieres que pueda volver a trabajar.",
  "users.activity.branch_filter_placeholder": "Filtrar por sucursal",
  "users.activity.branch_filter_all": "Todas las sucursales",
  "users.activity.no_actionable_perms_title": "Sin operaciones permitidas",
  "users.activity.no_actionable_perms_description": "Los roles asignados a {name} no le permiten crear movimientos de inventario, órdenes de venta ni despachos. Ajusta sus roles si quieres habilitar alguna de esas operaciones.",
  "users.activity.filters.section_label": "Filtros",
  "users.activity.filters.clear_label": "Limpiar",
  "users.activity.filters.from_label": "Desde",
  "users.activity.filters.to_label": "Hasta",
  "users.activity.filters.date_range_label": "Rango de fechas",
  "users.activity.filters.placeholder_any": "Todos",
  "users.activity.filters.branch_label": "Sucursal",
  "users.activity.filters.status_label": "Estado",
  "users.activity.filters.movement_type_label": "Tipo de movimiento",
  "users.activity.filters.dispatch_type_label": "Tipo de despacho",
  "users.activity.filters.warehouse_label": "Bodega",
  "users.activity.filters.product_label": "Producto",
  "users.activity.filters.customer_label": "Cliente",
  "users.activity.filters.vehicle_label": "Vehículo",
  "users.activity.filters.driver_label": "Conductor",
  "users.activity.filters.route_label": "Ruta",
  "users.activity.filters.page_size_label": "Por página",
  "users.activity.status.draft": "Borrador",
  "users.activity.status.posted": "Publicado",
  "users.activity.status.confirmed": "Confirmado",
  "users.activity.status.cancelled": "Cancelado",
  "users.activity.status.in_transit": "En tránsito",
  "users.activity.status.received": "Recibido",
  "users.activity.status.partially_received": "Parcial",
  "users.activity.status.ready": "Lista",
  "users.activity.status.dispatched": "Despachada",
  "users.activity.status.completed": "Completada",
  "users.activity.movement_type.purchase_receipt": "Recepción de compra",
  "users.activity.movement_type.sales_dispatch": "Despacho de venta",
  "users.activity.movement_type.sales_allocated": "Asignación de venta",
  "users.activity.movement_type.stock_adjustment": "Ajuste de stock",
  "users.activity.movement_type.transfer": "Transferencia",
  "users.activity.movement_type.manual_correction": "Corrección manual",
  "users.activity.movement_type.reservation": "Reservación",
  "users.activity.movement_type.release": "Liberación",
  "users.activity.movement_type.return_in": "Devolución entrante",
  "users.activity.movement_type.return_out": "Devolución saliente",
  "users.activity.movement_type.purchase_expected": "Compra esperada",
  "users.activity.movement_type.dispatch_cancelled": "Despacho cancelado",
  "users.activity.movement_type.dispatch_return": "Devolución de despacho",
  "users.activity.dispatch_type.individual": "Individual",
  "users.activity.dispatch_type.consolidated": "Consolidado",
  "users.activity.permission_required_title": "Sin permiso para ver movimientos",
  "users.activity.permission_required_description": "Necesitas inventory_movements.view, sale_orders.view o dispatch_orders.view para ver la actividad de este usuario.",
  "users.activity.movements_title": "Movimientos de inventario",
  "users.activity.loading_movements": "Cargando movimientos de inventario.",
  "users.activity.movements_empty_title": "Sin movimientos",
  "users.activity.movements_empty_description": "Este usuario aún no ha realizado movimientos de inventario.",
  "users.activity.sales_title": "Órdenes de venta",
  "users.activity.loading_sales": "Cargando órdenes de venta.",
  "users.activity.sales_empty_title": "Sin órdenes de venta",
  "users.activity.sales_empty_description": "Este usuario aún no ha creado órdenes de venta.",
  "users.activity.dispatch_title": "Órdenes de despacho",
  "users.activity.loading_dispatch": "Cargando órdenes de despacho.",
  "users.activity.dispatch_empty_title": "Sin órdenes de despacho",
  "users.activity.dispatch_empty_description": "Este usuario aún no ha creado órdenes de despacho.",
  "users.activity.load_more": "Cargar más",
  "users.activity.loading_more": "Cargando más…",
  "users.activity.end_of_list": "No hay más resultados.",
  "users.activity.scroll_to_top": "Ir al inicio",
  "users.activity.prev_page": "Anterior",
  "users.activity.next_page": "Siguiente",
  "users.activity.page_number": "Página {page}",
  "users.activity.loaded_count": "{count} cargados",
  "users.activity.total_records": "{count} registros",
  "users.activity.search_placeholder": "Buscar en estos registros…",
  "users.activity.detail.movement_description": "Información del movimiento de inventario.",
  "users.activity.detail.source_document": "Documento de origen",
  "users.activity.detail.notes": "Notas",
  "users.activity.no_roles_title": "Sin roles asignados",
  "users.activity.no_roles_description": "{name} no tiene roles asignados, por lo que no puede realizar movimientos de inventario, órdenes de venta ni despachos. Asigna al menos un rol para que pueda operar y aquí aparezca su actividad.",
  "users.activity.assign_roles_action": "Asignar roles",
  "users.activity.no_branches_warning": "{name} no tiene sucursales asignadas. Sin acceso a una sucursal no podrá realizar nuevas operaciones, aunque sí puedes ver actividad histórica.",
  "users.activity.assign_branches_action": "Asignar sucursales",
  "contacts.page_eyebrow": "Administración",
  "contacts.page_title": "Contactos",
  "contacts.page_description": "Gestiona clientes, proveedores y búsquedas de identificación desde la misma pantalla.",
  "contacts.page_access_denied": "No tienes permiso para ver contactos.",
  "contacts.create_button": "Crear contacto",
  "contacts.loading_contacts": "Cargando contactos.",
  "contacts.empty_title": "Sin contactos",
  "contacts.empty_description": "Crea el primer contacto para clientes, proveedores o ambos.",
  "contacts.active_branch_context": "Contexto de sucursal: {value}",
  "contacts.lookup_badge": "Búsqueda: {value}",
  "contacts.stats.registered_title": "Contactos registrados",
  "contacts.stats.registered_description": "Contactos devueltos por el backend para el tenant.",
  "contacts.stats.active_title": "Contactos activos",
  "contacts.stats.active_description": "Registros activos listos para ser reutilizados.",
  "contacts.lookup.card_title": "Búsqueda por identificación",
  "contacts.lookup.card_description": "Busca un contacto usando el endpoint de búsqueda del backend.",
  "contacts.lookup.search_button": "Buscar",
  "contacts.lookup.searching": "Buscando contacto por identificación.",
  "contacts.lookup.not_found_title": "Sin resultados",
  "contacts.lookup.not_found_description": "No se encontró contacto para {id}.",
  "contacts.lookup.identification": "Identificación: {value}",
  "contacts.lookup.no_identification": "Sin número de identificación",
  "contacts.lookup.email_label": "Correo: {value}",
  "contacts.lookup.phone_label": "Teléfono: {value}",
  "contacts.lookup.updated_label": "Actualizado: {value}",
  "contacts.lookup.edit_button": "Editar contacto",
  "contacts.table.header_contact": "Contacto",
  "contacts.table.header_identification": "Identificación",
  "contacts.table.header_contact_info": "Info de contacto",
  "contacts.table.no_commercial_name": "Sin nombre comercial.",
  "contacts.table.no_id_number": "Sin número de ID",
  "contacts.table.no_id_type": "Sin tipo de ID",
  "contacts.table.empty": "No se encontraron contactos.",
  "contacts.actions.edit": "Editar contacto",
  "contacts.actions.deactivate": "Desactivar",
  "contacts.actions.reactivate": "Reactivar",
  "contacts.actions.delete": "Eliminar permanentemente",
  "contacts.actions.branch_context": "Contexto de sucursal",
  "contacts.delete_dialog_title": "Eliminar contacto permanentemente",
  "contacts.delete_dialog_description": "Esto elimina permanentemente a {name}. Esta acción no se puede deshacer.",
  "contacts.deactivate_dialog_title": "Desactivar contacto",
  "contacts.deactivate_dialog_description": "{name} permanecerá visible en el historial, pero no debe usarse en nuevas operaciones.",
  "contacts.reactivate_dialog_title": "Reactivar contacto",
  "contacts.reactivate_dialog_description": "{name} volverá a estar disponible para nuevas operaciones y búsquedas.",
  "branches.page_eyebrow": "Administración",
  "branches.page_title": "Sucursales",
  "branches.page_description": "Gestiona metadatos de sucursal y configuración de terminales desde el panel administrativo.",
  "branches.page_access_denied": "No tienes permiso para ver sucursales.",
  "branches.create_button": "Crear sucursal",
  "branches.active_context_badge": "Contexto activo: {value}",
  "branches.selected_badge": "Seleccionada: {name}",
  "branches.loading_branches": "Cargando sucursales.",
  "branches.empty_title": "Sin sucursales",
  "branches.empty_description": "Crea la primera sucursal para configurar el contexto multisucursal.",
  "branches.stats.visible_branches_title": "Sucursales visibles",
  "branches.stats.visible_branches_description": "Sucursales devueltas por el backend para el tenant.",
  "branches.stats.visible_terminals_title": "Terminales visibles",
  "branches.stats.visible_terminals_description": "Total de terminales de la lista actual de sucursales.",
  "branches.stats.context_title": "Contexto de sucursal",
  "branches.stats.context_description": "El contexto de sucursal usado por el shell y el selector.",
  ...
  "branches.detail.reference_description": "Código si está disponible, de lo contrario el ID interno.",
  "branches.detail.assigned_terminals_title": "Terminales asignados",
  "branches.detail.assigned_terminals_description": "Total de terminales del endpoint de detalle.",
  "branches.detail.loading": "Cargando detalle y terminales de la sucursal.",
  ...
  "branches.table.active_context_badge": "Contexto activo",
  "branches.table.viewing_terminals_badge": "Viendo terminales",
  "branches.table.code_prefix": "Código: {code}",
  "branches.table.no_address": "Sin dirección registrada.",
  "branches.table.empty": "No se encontraron sucursales.",
  "branches.actions.view_terminals": "Ver terminales",
  "branches.actions.edit": "Editar sucursal",
  "branches.actions.deactivate": "Desactivar",
  "branches.actions.reactivate": "Reactivar",
  "branches.actions.delete": "Eliminar permanentemente",
  "branches.delete_dialog_title": "Eliminar sucursal permanentemente",
  "branches.delete_dialog_description": "Esto elimina permanentemente la sucursal si el backend confirma que no tiene dependencias operativas.",
  "branches.deactivate_dialog_title": "Desactivar sucursal",
  "branches.deactivate_dialog_description": "{name} quedará registrada pero debe dejar de usarse en nuevas operaciones.",
  "branches.reactivate_dialog_title": "Reactivar sucursal",
  "branches.reactivate_dialog_description": "{name} volverá a estar disponible para selección y uso operativo.",
  "branches.terminals.table.header_terminal": "Terminal",
  "branches.terminals.table.code_prefix": "Código: {code}",
  "branches.terminals.table.no_code": "Sin código.",
  "branches.terminals.table.empty": "No se encontraron terminales para esta sucursal.",
  "branches.terminals.actions.edit": "Editar terminal",
  "branches.terminals.delete_title": "Eliminar terminal permanentemente",
  "branches.terminals.delete_description": "Esto elimina permanentemente el terminal {name}. Esta acción no se puede deshacer.",
  "branches.terminals.deactivate_title": "Desactivar terminal",
  "branches.terminals.deactivate_description": "{name} permanecerá registrado pero debe dejar de usarse operativamente.",
  "branches.terminals.reactivate_title": "Reactivar terminal",
  "branches.terminals.reactivate_description": "{name} volverá a estar disponible para uso operativo.",
  "nav.dashboard": "Panel",
  "nav.business": "Empresa",
  "nav.roles": "Roles",
  "nav.inventory": "Inventario",
  "nav.sales": "Ventas",
  "nav.dispatch": "Despachos",
} as const;
...
export const translations: Record<AppLanguage, TranslationDictionary> = {
  en: {
    ...
    "branches.create_title": "Create branch",
    "branches.create_description": "Register a new branch.",
    "branches.edit_title": "Edit branch",
    "branches.edit_description": "Update branch information.",
    "branches.create_terminal_title": "Create terminal",
    "branches.create_terminal_description": "Add a new terminal to {branch}.",
    "branches.edit_terminal_title": "Edit terminal",
    "branches.edit_terminal_description": "Update the terminal configuration.",
    ...
    "common.clear": "Clear",
    "common.apply": "Apply",
    "date_range.placeholder": "Any date",
    "date_range.preset_today": "Today",
    "date_range.preset_this_week": "This week",
    ...
    "contacts.hacienda.lookup_button": "Lookup Hacienda",
    "contacts.hacienda.lookup_error": "Unable to query Hacienda.",
    "contacts.hacienda.lookup_success": "Taxpayer data loaded from Hacienda.",
    "contacts.hacienda.not_found": "Taxpayer not found in Hacienda.",
    "contacts.hacienda.select_activity": "Select an economic activity",
    "contacts.hacienda.select_activity_description":
      "The taxpayer has multiple registered activities. Select the one that applies.",
    "contacts.hacienda.verify_button": "Verify",
    "contacts.hacienda.verify_error": "Unable to verify the exoneration document.",
    "contacts.hacienda.verify_success": "Exoneration data loaded from Hacienda.",
    "contacts.hacienda.verifying": "Verifying...",
    "contacts.branch_assignments.account_manager": "Account manager",
    ...
    "contacts.form.canton_placeholder": "E.g.: Central",
    ...
    "contacts.form.district_placeholder": "E.g.: Carmen",
    "contacts.form.document_number": "Document number",
    "contacts.form.economic_activity_code": "Economic activity code",
    "contacts.form.economic_activity_code_placeholder": "Filled when looking up Hacienda",
    "contacts.form.email": "Email",
    "contacts.form.email_placeholder": "email@company.com",
    "contacts.form.exoneration_description": "Optional fields for special tax conditions.",
    "contacts.form.exoneration_document_placeholder": "E.g.: AL-00460853-20",
    "contacts.form.exoneration_institution_placeholder": "Filled when verifying",
    "contacts.form.exoneration_percentage": "Exoneration percentage",
    "contacts.form.exoneration_percentage_placeholder": "E.g.: 13",
    "contacts.form.exoneration_title": "Exoneration",
    "contacts.form.exoneration_type": "Exoneration type",
    "contacts.form.exoneration_type_placeholder": "Filled when verifying",
    ...
    "contacts.form.identification_number_placeholder": "E.g.: 3101025306",
    ...
    "contacts.form.province_placeholder": "E.g.: San José",
    ...
    "contacts.form.tax_condition_placeholder": "Filled when looking up Hacienda",
    "contacts.form.type": "Type",
    "contacts.update_error_fallback": "Unable to update the contact.",
    "contacts.create_title": "Create contact",
    "contacts.create_description": "Register a new customer, supplier or contact.",
    "contacts.edit_title": "Edit contact",
    "contacts.edit_description": "Update the selected contact.",
    "contacts.loading_details": "Loading contact details.",
    ...
    "inventory.common.date": "Date",
    "inventory.common.number": "Number",
    "inventory.common.email": "Email",
    ...
    "inventory.cabys.no_results": "No results in CABYS catalog",
    "inventory.cabys.search_placeholder": "Search goods or services in CABYS...",
    "inventory.cabys.tax_rate": "VAT",
    ...
    "inventory.dispatch.change_stop_status": "Change status",
    ...
    "roles.create_description": "Create a new role for RBAC administration.",
    "roles.edit_title": "Edit role",
    "roles.edit_description": "Update the details of this role.",
    "roles.page_title": "Roles",
    "roles.page_description": "Manage roles, edit metadata and assign permission sets for RBAC.",
    "roles.page_eyebrow": "Administration",
    "roles.page_access_denied": "You do not have permission to view roles.",
    "roles.create_button": "Create role",
    "roles.loading": "Loading roles.",
    "roles.load_error_fallback": "Unable to load roles.",
    "roles.empty_title": "No roles found",
    "roles.empty_description": "Create the first role to start structuring RBAC.",
    "roles.source_badge": "Roles source: /api/roles",
    "roles.permissions_catalog_badge": "Permissions catalog: {count}",
    "roles.permissions_catalog_loading": "loading",
    "roles.table.header_role": "Role",
    "roles.table.header_role_key": "Role key",
    "roles.table.header_permissions": "Permissions",
    "roles.table.system_badge": "System",
    "roles.table.code_prefix": "Code: {code}",
    "roles.table.key_prefix": "Key: {key}",
    "roles.table.no_permissions": "No permissions",
    "roles.table.empty": "No roles found.",
    "roles.actions.edit": "Edit role",
    "roles.actions.assign_permissions": "Assign permissions",
    "roles.actions.delete": "Delete role",
    "roles.delete_title": "Delete role",
    "roles.delete_description": "This will remove the role {name}.",
    "roles.delete_confirm": "Delete role",
    "roles.form.name_label": "Name",
    "roles.form.name_placeholder": "e.g. Manager",
    "roles.form.role_key_label": "Role key",
    "roles.form.role_key_placeholder": "e.g. manager",
    ...
    "users.create_description": "Create a new user.",
    "users.edit_title": "Edit user",
    "users.edit_description": "Update user information.",
    "users.loading_details": "Loading user details.",
    "users.change_password_title": "Change password",
    "users.change_password_description": "Set a new password for this user.",
    "users.new_password": "New password",
    "users.confirm_password": "Confirm password",
    "users.update_password": "Update password",
    "users.change_status_title": "Change user status",
    "users.change_status_description": "Use lifecycle status for non-destructive user administration.",
    "users.status_label": "Status",
    "users.status_placeholder": "Select a status",
    "users.allow_login": "Allow login",
    "users.allow_login_description": "Toggle whether this user can authenticate.",
    "users.save_status": "Save status",
    "users.status_active_description": "User can operate normally.",
    "users.status_inactive_description": "User remains registered but should not operate.",
    "users.status_suspended_description": "Access is temporarily suspended.",
    "users.status_deleted_description": "Logical deleted status only.",
    "users.assign_roles_title": "Assign roles",
    "users.assign_roles_description": "Update the roles assigned to {name}.",
    "users.save_roles": "Save roles",
    "users.loading_roles": "Loading available roles.",
    "users.load_roles_error": "Unable to load roles.",
    "users.no_roles_title": "No roles available",
    "users.no_roles_description": "No roles are available to assign yet.",
    "users.role_code": "Code: {code}",
    "users.role_key": "Key: {key}",
    "users.assign_branches_title": "Assign branches",
    "users.assign_branches_description": "Update the branch access for {name}.",
    "users.active_branch_badge": "Active branch: {branch}",
    "users.allowed_branches_badge": "Allowed branches: {count}",
    "users.loading_branches": "Loading branches.",
    "users.load_branches_error": "Unable to load branches.",
    "users.no_branches_title": "No branches available",
    "users.no_branches_description": "No branches were returned by the backend.",
    "users.save_branches": "Save branches",
    "users.effective_permissions_title": "Effective permissions",
    "users.effective_permissions_description": "Permissions currently resolved for {name}.",
    "users.loading_permissions": "Loading effective permissions.",
    "users.load_permissions_error": "Unable to load effective permissions.",
    "users.no_permissions_title": "No permissions",
    "users.no_permissions_description": "This user does not currently resolve any effective permissions.",
    "inventory.dispatch_order_create_error_fallback":
    ...
    "inventory.dispatch.add_stop_description": "Add a stop to this dispatch order.",
    "inventory.dispatch.select_sale_order": "Select a sale order",
    "inventory.dispatch.search_sale_orders_placeholder": "Search by code or customer…",
    "inventory.dispatch.delivery_sequence": "Delivery sequence",
    ...
    "auth.login_title": "Administrative access",
    "auth.login_description": "Sign in with your account. Session is maintained with HttpOnly cookies.",
    "auth.email_label": "Email",
    "auth.password_label": "Password",
    "auth.password_placeholder": "Enter your password",
    "auth.logging_in": "Signing in",
    "auth.login_button": "Sign in",
    "auth.login_error_fallback": "Unable to sign in.",
    "auth.superadmin_hint": "New business onboarding now lives inside the platform panel for users with super admin access.",
    "branches.form.map_location": "Map location",
    "branches.switcher.business_level_context": "Active context: business level",
    "branches.switcher.fixed_branch": "Fixed branch: {label}",
    "branches.switcher.no_branches": "No branches",
    "branches.switcher.select_branch": "Select branch",
    "contacts.form.map_location": "Map location",
    "sales.form.seller_route_requires_delivery": "Seller route requires home delivery.",
    "sales.form.select_branch": "Select a branch",
    "sales.form.select_customer": "Select a customer",
    "sales.form.no_seller_assigned": "No seller assigned",
    "sales.form.no_seller": "No seller",
    "sales.form.no_warehouse_assigned": "No warehouse assigned",
    "sales.form.no_warehouse": "No warehouse",
    "sales.form.no_zone_assigned": "No zone assigned",
    "sales.form.no_zone": "No zone",
    "sales.form.select_product": "Select product",
    "sales.form.stock_label": "({count} avail.)",
    "sales.charge_type_shipping": "Shipping",
    "sales.charge_type_installation": "Installation",
    "sales.charge_type_express": "Express",
    "common.access_denied_title": "Access denied",
    "common.none": "None",
    "common.active_status": "ACTIVE",
    "common.inactive_status": "INACTIVE",
    ...
    "users.page_eyebrow": "Administration",
    "users.page_title": "Users",
    "users.page_description": "Manage users, statuses, passwords, roles, branches and effective permissions.",
    "users.page_access_denied": "You do not have permission to view users.",
    "users.loading_users": "Loading users.",
    "users.create_button": "Create user",
    "users.empty_title": "No users found",
    "users.empty_description": "Create the first user record for this business.",
    "users.active_branch_context": "Active branch: {value}",
    "users.table.header_user": "User",
    "users.table.header_status": "Status",
    "users.table.header_roles": "Roles",
    "users.table.header_branches": "Branches",
    "users.table.header_max_discount": "Max discount",
    "users.table.header_updated": "Updated",
    "users.table.header_actions": "Actions",
    "users.table.no_roles": "No roles",
    "users.table.branches_assigned": "{count} assigned",
    "users.table.empty": "No users found.",
    "users.actions.menu_label": "Actions",
    "users.actions.edit": "Edit user",
    "users.actions.change_status": "Change status",
    "users.actions.change_password": "Change password",
    "users.actions.assign_roles": "Assign roles",
    "users.actions.assign_branches": "Assign branches",
    ...
    "users.delete_dialog_description": "This permanently deletes {name}. Use status changes for regular administration and reserve delete for cleanup of users without operational history.",
    "users.kpi.total_title": "Users",
    "users.kpi.active_hint": "{count} active",
    "users.kpi.branches_title": "Branches",
    "users.kpi.filtered_title": "In view",
    "users.search_placeholder": "Search by name, email or code…",
    "users.branch_filter.placeholder": "Filter by branch",
    "users.branch_filter.all": "All branches",
    "users.branch_filter.none": "Without branch assigned",
    "users.filter_results": "{count} of {total} users",
    "users.filter_empty_title": "No matches",
    "users.filter_empty_description": "Adjust the search or branch filter to see users.",
    "users.select_user_title": "Select a user",
    "users.select_user_description": "Pick a user from the list to view their detail, roles, branches and permissions.",
    "users.detail.platform_admin_badge": "Platform admin",
    "users.detail.roles_count": "{count} role(s)",
    "users.detail.branches_count": "{count} branch(es)",
    "users.detail.last_login": "Last login: {value}",
    "users.detail.tabs.roles": "Roles ({count})",
    "users.detail.tabs.branches": "Branches ({count})",
    "users.detail.tabs.permissions": "Effective permissions",
    "users.detail.tabs.activity": "Activity",
    "users.detail.roles_empty_title": "No roles assigned",
    "users.detail.roles_empty_description": "This user has no roles assigned yet.",
    "users.detail.roles_empty_guidance": "{name} has no roles. Without a role they cannot sign in with permissions or operate in the system. Assign at least one role so they have effective permissions.",
    "users.detail.branches_empty_title": "No branches assigned",
    "users.detail.branches_empty_description": "This user has no branch access yet.",
    "users.detail.branches_empty_guidance": "{name} has no branches assigned. Without branch access they cannot operate (sell, dispatch or move inventory). Assign at least one branch where they can work.",
    "users.detail.branches_empty_privileged": "{name} is an owner or platform admin and operates at the business level, so explicit branch assignment is not required.",
    "users.detail.permissions_no_roles_title": "No effective permissions",
    "users.detail.permissions_no_roles_description": "{name} has no permissions because they have no roles assigned. Effective permissions come from roles. Assign at least one role so permissions show up here.",
    "users.detail.permissions_empty_with_roles_title": "Roles without permissions",
    "users.detail.permissions_empty_with_roles_description": "{name} has roles assigned but none of them grants any permission. Edit those roles from the Roles section to configure their permissions.",
    "users.detail.permissions_group_count": "{count} permissions",
    "users.detail.permissions_empty_privileged_title": "Implicit full access",
    "users.detail.permissions_empty_privileged_description": "{name} is an owner or platform admin and therefore has full access regardless of the computed effective permissions.",
    "users.detail.roles_platform_admin_title": "Roles not applicable",
    "users.detail.roles_platform_admin_description": "{name} is a platform admin: roles are not assigned because they have implicit full access to all system operations.",
    "users.detail.branches_platform_admin_title": "Branches not applicable",
    "users.detail.branches_platform_admin_description": "{name} is a platform admin and operates at platform level, so branch assignment is not required: they can act on any branch.",
    "users.detail.status_warning_title": "User status: {status}",
    "users.detail.status_warning_description": "While the user is not active, they cannot sign in or operate. Switch the status back to Active if you want them to work again.",
    "users.activity.branch_filter_placeholder": "Filter by branch",
    "users.activity.branch_filter_all": "All branches",
    "users.activity.no_actionable_perms_title": "No allowed operations",
    "users.activity.no_actionable_perms_description": "The roles assigned to {name} do not allow them to create inventory movements, sale orders or dispatches. Adjust their roles to enable any of those operations.",
    "users.activity.filters.section_label": "Filters",
    "users.activity.filters.clear_label": "Clear",
    "users.activity.filters.from_label": "From",
    "users.activity.filters.to_label": "To",
    "users.activity.filters.date_range_label": "Date range",
    "users.activity.filters.placeholder_any": "Any",
    "users.activity.filters.branch_label": "Branch",
    "users.activity.filters.status_label": "Status",
    "users.activity.filters.movement_type_label": "Movement type",
    "users.activity.filters.dispatch_type_label": "Dispatch type",
    "users.activity.filters.warehouse_label": "Warehouse",
    "users.activity.filters.product_label": "Product",
    "users.activity.filters.customer_label": "Customer",
    "users.activity.filters.vehicle_label": "Vehicle",
    "users.activity.filters.driver_label": "Driver",
    "users.activity.filters.route_label": "Route",
    "users.activity.filters.page_size_label": "Per page",
    "users.activity.status.draft": "Draft",
    "users.activity.status.posted": "Posted",
    "users.activity.status.confirmed": "Confirmed",
    "users.activity.status.cancelled": "Cancelled",
    "users.activity.status.in_transit": "In transit",
    "users.activity.status.received": "Received",
    "users.activity.status.partially_received": "Partially received",
    "users.activity.status.ready": "Ready",
    "users.activity.status.dispatched": "Dispatched",
    "users.activity.status.completed": "Completed",
    "users.activity.movement_type.purchase_receipt": "Purchase receipt",
    "users.activity.movement_type.sales_dispatch": "Sales dispatch",
    "users.activity.movement_type.sales_allocated": "Sales allocated",
    "users.activity.movement_type.stock_adjustment": "Stock adjustment",
    "users.activity.movement_type.transfer": "Transfer",
    "users.activity.movement_type.manual_correction": "Manual correction",
    "users.activity.movement_type.reservation": "Reservation",
    "users.activity.movement_type.release": "Release",
    "users.activity.movement_type.return_in": "Inbound return",
    "users.activity.movement_type.return_out": "Outbound return",
    "users.activity.movement_type.purchase_expected": "Expected purchase",
    "users.activity.movement_type.dispatch_cancelled": "Dispatch cancelled",
    "users.activity.movement_type.dispatch_return": "Dispatch return",
    "users.activity.dispatch_type.individual": "Individual",
    "users.activity.dispatch_type.consolidated": "Consolidated",
    "users.activity.permission_required_title": "No permission to view activity",
    "users.activity.permission_required_description": "You need inventory_movements.view, sale_orders.view or dispatch_orders.view to view this user's activity.",
    "users.activity.movements_title": "Inventory movements",
    "users.activity.loading_movements": "Loading inventory movements.",
    "users.activity.movements_empty_title": "No movements",
    "users.activity.movements_empty_description": "This user has not performed any inventory movements yet.",
    "users.activity.sales_title": "Sale orders",
    "users.activity.loading_sales": "Loading sale orders.",
    "users.activity.sales_empty_title": "No sale orders",
    "users.activity.sales_empty_description": "This user has not created any sale orders yet.",
    "users.activity.dispatch_title": "Dispatch orders",
    "users.activity.loading_dispatch": "Loading dispatch orders.",
    "users.activity.dispatch_empty_title": "No dispatch orders",
    "users.activity.dispatch_empty_description": "This user has not created any dispatch orders yet.",
    "users.activity.load_more": "Load more",
    "users.activity.loading_more": "Loading more…",
    "users.activity.end_of_list": "No more results.",
    "users.activity.scroll_to_top": "Scroll to top",
    "users.activity.prev_page": "Previous",
    "users.activity.next_page": "Next",
    "users.activity.page_number": "Page {page}",
    "users.activity.loaded_count": "{count} loaded",
    "users.activity.total_records": "{count} records",
    "users.activity.search_placeholder": "Search in these records…",
    "users.activity.detail.movement_description": "Inventory movement details.",
    "users.activity.detail.source_document": "Source document",
    "users.activity.detail.notes": "Notes",
    "users.activity.no_roles_title": "No roles assigned",
    "users.activity.no_roles_description": "{name} has no roles assigned, so they cannot perform inventory movements, sale orders or dispatches. Assign at least one role so they can operate and their activity shows up here.",
    "users.activity.assign_roles_action": "Assign roles",
    "users.activity.no_branches_warning": "{name} has no branches assigned. Without access to a branch they cannot perform new operations, although you can still see historical activity.",
    "users.activity.assign_branches_action": "Assign branches",
    "contacts.page_eyebrow": "Administration",
    "contacts.page_title": "Contacts",
    "contacts.page_description": "Manage customers, suppliers and identification lookups from the same administrative screen.",
    "contacts.page_access_denied": "You do not have permission to view contacts.",
    "contacts.create_button": "Create contact",
    "contacts.loading_contacts": "Loading contacts.",
    "contacts.empty_title": "No contacts found",
    "contacts.empty_description": "Create the first contact record for customers, suppliers or both.",
    "contacts.active_branch_context": "Active branch: {value}",
    "contacts.lookup_badge": "Lookup: {value}",
    "contacts.stats.registered_title": "Registered contacts",
    "contacts.stats.registered_description": "Contacts returned by the backend for the authenticated tenant.",
    "contacts.stats.active_title": "Active contacts",
    "contacts.stats.active_description": "Active records ready to be reused by future modules.",
    "contacts.lookup.card_title": "Lookup by identification",
    "contacts.lookup.card_description": "Search a contact record using the backend lookup endpoint.",
    "contacts.lookup.search_button": "Search",
    "contacts.lookup.searching": "Searching contact by identification.",
    "contacts.lookup.not_found_title": "No contact found",
    "contacts.lookup.not_found_description": "No contact was returned for {id}.",
    "contacts.lookup.identification": "Identification: {value}",
    "contacts.lookup.no_identification": "No identification number",
    "contacts.lookup.email_label": "Email: {value}",
    "contacts.lookup.phone_label": "Phone: {value}",
    "contacts.lookup.updated_label": "Updated: {value}",
    "contacts.lookup.edit_button": "Edit contact",
    "contacts.table.header_contact": "Contact",
    "contacts.table.header_identification": "Identification",
    "contacts.table.header_contact_info": "Contact info",
    "contacts.table.no_commercial_name": "No commercial name provided.",
    "contacts.table.no_id_number": "No ID number",
    "contacts.table.no_id_type": "No ID type",
    "contacts.table.empty": "No contacts found.",
    "contacts.actions.edit": "Edit contact",
    "contacts.actions.deactivate": "Deactivate",
    "contacts.actions.reactivate": "Reactivate",
    "contacts.actions.delete": "Delete permanently",
    "contacts.actions.branch_context": "Branch context",
    "contacts.delete_dialog_title": "Delete contact permanently",
    "contacts.delete_dialog_description": "This permanently deletes {name}. This action cannot be undone.",
    "contacts.deactivate_dialog_title": "Deactivate contact",
    "contacts.deactivate_dialog_description": "{name} will remain visible for history, but it should no longer be used in new operations.",
    "contacts.reactivate_dialog_title": "Reactivate contact",
    "contacts.reactivate_dialog_description": "{name} will become available again for new operations and lookups.",
    "branches.page_eyebrow": "Administration",
    "branches.page_title": "Branches",
    "branches.page_description": "Manage branch metadata and terminal configuration without leaving the admin shell.",
    "branches.page_access_denied": "You do not have permission to view branches.",
    "branches.create_button": "Create branch",
    "branches.active_context_badge": "Active context: {value}",
    "branches.selected_badge": "Selected: {name}",
    "branches.loading_branches": "Loading branches.",
    "branches.empty_title": "No branches found",
    "branches.empty_description": "Create the first branch to start configuring the multisucursal context.",
    "branches.stats.visible_branches_title": "Visible branches",
    "branches.stats.visible_branches_description": "Branches returned by the backend for the authenticated tenant.",
    "branches.stats.visible_terminals_title": "Visible terminals",
    "branches.stats.visible_terminals_description": "Terminal count aggregated from the current branch list.",
    "branches.stats.context_title": "Current branch context",
    "branches.stats.context_description": "The branch context used by the shared shell and switcher.",
    "branches.selected_section_description": "Review and manage the terminals assigned to this branch.",
    "branches.use_as_context_button": "Use as active context",
    "branches.create_terminal_button": "Create terminal",
    "branches.selected_section_fallback": "Selected branch",
    "branches.detail.status_title": "Branch status",
    "branches.detail.status_description": "Active or inactive state returned by the backend.",
    "branches.detail.reference_title": "Reference",
    "branches.detail.reference_description": "Branch code if available, otherwise the internal id.",
    "branches.detail.assigned_terminals_title": "Assigned terminals",
    "branches.detail.assigned_terminals_description": "Terminal count resolved from the branch detail endpoint.",
    "branches.detail.loading": "Loading branch detail and terminals.",
    "branches.no_terminals_title": "No terminals found",
    "branches.no_terminals_description": "This branch has no terminals yet.",
    "branches.load_error_fallback": "Unable to load branches.",
    "branches.selected_load_error_fallback": "Unable to load the selected branch.",
    "branches.table.header_branch": "Branch",
    "branches.table.header_terminals": "Terminals",
    "branches.table.header_contact": "Contact",
    "branches.table.active_context_badge": "Active context",
    "branches.table.viewing_terminals_badge": "Viewing terminals",
    "branches.table.code_prefix": "Code: {code}",
    "branches.table.no_address": "No address provided.",
    "branches.table.empty": "No branches found.",
    "branches.actions.view_terminals": "View terminals",
    "branches.actions.edit": "Edit branch",
    "branches.actions.deactivate": "Deactivate",
    "branches.actions.reactivate": "Reactivate",
    "branches.actions.delete": "Delete permanently",
    "branches.delete_dialog_title": "Delete branch permanently",
    "branches.delete_dialog_description": "This permanently deletes the branch if the backend confirms there are no operational dependencies.",
    "branches.deactivate_dialog_title": "Deactivate branch",
    "branches.deactivate_dialog_description": "{name} will stay registered, but it should stop being used for new operations.",
    "branches.reactivate_dialog_title": "Reactivate branch",
    "branches.reactivate_dialog_description": "{name} will become available again for branch selection and operational use.",
    "branches.terminals.table.header_terminal": "Terminal",
    "branches.terminals.table.code_prefix": "Code: {code}",
    "branches.terminals.table.no_code": "No code provided.",
    "branches.terminals.table.empty": "No terminals found for this branch.",
    "branches.terminals.actions.edit": "Edit terminal",
    "branches.terminals.delete_title": "Delete terminal permanently",
    "branches.terminals.delete_description": "This permanently deletes terminal {name}. This action cannot be undone.",
    "branches.terminals.deactivate_title": "Deactivate terminal",
    "branches.terminals.deactivate_description": "{name} will remain registered, but it should stop being used operationally.",
    "branches.terminals.reactivate_title": "Reactivate terminal",
    "branches.terminals.reactivate_description": "{name} will become available again for operational use.",
